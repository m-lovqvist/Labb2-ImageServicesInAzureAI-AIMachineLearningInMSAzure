...
namespace Labb2_ImageServicesInAzureAI_AIMachineLearningInMSAzure.Controllers
{
    public class ImageController : Controller
    {
        ...
        public IActionResult Index() // Method to show upload index
        {
            return View();
        }

        [HttpGet]
        public IActionResult Upload() // Displaying upload form
        {
            return View();
        }
        ...
        private string ConvertToBase64(Stream stream) // Converting a stream to a Base64 string
        {
